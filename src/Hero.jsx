                    ...
                    <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center" data-aos="fade-up">
                            ...
                            <div className="flex flex-col my-4 items-center md:flex-row justify-center gap-4">
                                <a className="bg-transparent text-sm max-w-1/2 md:max-w-1/8 text-emerald-300 px-4 py-3 rounded-full font-medium border-2 border-gray-700 hover:text-gray-300 cursor-pointer transition-colors" href='https://drive.google.com/file/d/16t7y8G9NlfJVKRVl4sshQY1Xmz1nbZrY/view?usp=sharing' target='_blank'>
                                    View Resume
                                </a>
                            </div>
                        </div>
